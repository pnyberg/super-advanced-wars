...
public class FiringCursor {
	...
	public FiringCursor(DimensionObject mapDim, UnitGetter unitGetter, HeroHandler heroHandler, DamageHandler damageHandler, StructureHandler structureHandler) {
		this.mapDim = mapDim;
