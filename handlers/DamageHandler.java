...
//		SUB = 18;
	...
	private static void implementDamageMatrix() {
		for (int i = 0 ; i < number ; i++) {
			...
			damageMatrix[APC_v][i][0] = -1;
			damageMatrix[APC_v][i][1] = -1;
			damageMatrix[ARTILLERY][i][1] = -1;
			damageMatrix[ROCKET][i][1] = -1;
			damageMatrix[A_AIR][i][1] = -1;
			damageMatrix[MISSILES][i][1] = -1;

			damageMatrix[FIGHTER][i][1] = -1;
			damageMatrix[BOMBER][i][1] = -1;
			damageMatrix[TCOPTER][i][0] = -1;
			damageMatrix[TCOPTER][i][1] = -1;

			damageMatrix[BATTLESHIP][i][1] = -1;
...
//------------ Ground ----------------
		...
		damageMatrix[INFANTRY][APC_v][1] = 14;
...
//		damageMatrix[INFANTRY][SUB][1] = -1;
		...
		damageMatrix[MECH][APC_v][0] = 75;
		damageMatrix[MECH][APC_v][1] = 20;
...
//		damageMatrix[RECON][SUB][1] = -1;
		...
		damageMatrix[TANK][APC_v][0] = 75;
		damageMatrix[TANK][APC_v][1] = 45;
...
//		damageMatrix[TANK][SUB][1] = -1;
		...
		damageMatrix[MDTANK][APC_v][0] = 105;
		damageMatrix[MDTANK][APC_v][1] = 45;
...
//		damageMatrix[MDTANK][SUB][1] = -1;
		...
		damageMatrix[NEOTANK][APC_v][0] = 125;
		damageMatrix[NEOTANK][APC_v][1] = 65;
...
//		damageMatrix[NEOTANK][SUB][1] = -1;
		...
		damageMatrix[ARTILLERY][MECH][0] = 85;
		damageMatrix[ARTILLERY][RECON][0] = 80;
		damageMatrix[ARTILLERY][TANK][0] = 70;
		damageMatrix[ARTILLERY][MDTANK][0] = 45;
		damageMatrix[ARTILLERY][NEOTANK][0] = 40;
		damageMatrix[ARTILLERY][APC_v][0] = 70;
		damageMatrix[ARTILLERY][ARTILLERY][0] = 75;
		damageMatrix[ARTILLERY][ROCKET][0] = 80;
		damageMatrix[ARTILLERY][A_AIR][0] = 75;
		damageMatrix[ARTILLERY][MISSILES][0] = 80;
		damageMatrix[ARTILLERY][FIGHTER][0] = -1;
		damageMatrix[ARTILLERY][BOMBER][0] = -1;
		damageMatrix[ARTILLERY][BCOPTER][0] = -1;
		damageMatrix[ARTILLERY][TCOPTER][0] = -1;
...
//		damageMatrix[ARTILLERY][SUB][0] = 60;
		...
		damageMatrix[ROCKET][MECH][0] = 90;
		damageMatrix[ROCKET][RECON][0] = 90;
		damageMatrix[ROCKET][TANK][0] = 80;
		damageMatrix[ROCKET][MDTANK][0] = 55;
		damageMatrix[ROCKET][NEOTANK][0] = 50;
		damageMatrix[ROCKET][APC_v][0] = 80;
		damageMatrix[ROCKET][ARTILLERY][0] = 80;
		damageMatrix[ROCKET][ROCKET][0] = 85;
		damageMatrix[ROCKET][A_AIR][0] = 85;
		damageMatrix[ROCKET][MISSILES][0] = 90;
		damageMatrix[ROCKET][FIGHTER][0] = -1;
		damageMatrix[ROCKET][BOMBER][0] = -1;
		damageMatrix[ROCKET][BCOPTER][0] = -1;
		damageMatrix[ROCKET][TCOPTER][0] = -1;
...
//		damageMatrix[A_AIR][SUB][0] = -1;
		...
		damageMatrix[MISSILES][MECH][0] = -1;
		damageMatrix[MISSILES][RECON][0] = -1;
		damageMatrix[MISSILES][TANK][0] = -1;
		damageMatrix[MISSILES][MDTANK][0] = -1;
		damageMatrix[MISSILES][NEOTANK][0] = -1;
		damageMatrix[MISSILES][APC_v][0] = -1;
		damageMatrix[MISSILES][ARTILLERY][0] = -1;
		damageMatrix[MISSILES][ROCKET][0] = -1;
		damageMatrix[MISSILES][A_AIR][0] = -1;
		damageMatrix[MISSILES][MISSILES][0] = -1;
		damageMatrix[MISSILES][FIGHTER][0] = 100;
		damageMatrix[MISSILES][BOMBER][0] = 100;
		damageMatrix[MISSILES][BCOPTER][0] = 120;
		damageMatrix[MISSILES][TCOPTER][0] = 120;
...
//------------ Air ----------------
		...
		damageMatrix[FIGHTER][APC_v][0] = -1;
...
//		damageMatrix[FIGHTER][SUB][0] = -1;
		...
		damageMatrix[BOMBER][APC_v][0] = 105;
...
//		damageMatrix[BOMBER][SUB][0] = 95;
		...
		damageMatrix[BCOPTER][APC_v][0] = 60;
		damageMatrix[BCOPTER][APC_v][1] = 20;
...
//------------ Sea ----------------
		...
		// @battleship
		damageMatrix[BATTLESHIP][INFANTRY][0] = 95;
		damageMatrix[BATTLESHIP][MECH][0] = 90;
		damageMatrix[BATTLESHIP][RECON][0] = 90;
		damageMatrix[BATTLESHIP][TANK][0] = 80;
		damageMatrix[BATTLESHIP][MDTANK][0] = 55;
		damageMatrix[BATTLESHIP][NEOTANK][0] = 50;
		damageMatrix[BATTLESHIP][APC_v][0] = 80;
		damageMatrix[BATTLESHIP][ARTILLERY][0] = 80;
		damageMatrix[BATTLESHIP][ROCKET][0] = 85;
		damageMatrix[BATTLESHIP][A_AIR][0] = 85;
		damageMatrix[BATTLESHIP][MISSILES][0] = 90;
		damageMatrix[BATTLESHIP][FIGHTER][0] = -1;
		damageMatrix[BATTLESHIP][BOMBER][0] = -1;
		damageMatrix[BATTLESHIP][BCOPTER][0] = -1;
		damageMatrix[BATTLESHIP][TCOPTER][0] = -1;
...
//		damageMatrix[BATTLESHIP][SUB][0] = 95;
		...
		damageMatrix[CRUISER][INFANTRY][1] = -1;
		damageMatrix[CRUISER][MECH][0] = -1;
		damageMatrix[CRUISER][MECH][1] = -1;
		damageMatrix[CRUISER][RECON][0] = -1;
		damageMatrix[CRUISER][RECON][1] = -1;
		damageMatrix[CRUISER][TANK][0] = -1;
		damageMatrix[CRUISER][TANK][1] = -1;
		damageMatrix[CRUISER][MDTANK][0] = -1;
		damageMatrix[CRUISER][MDTANK][1] = -1;
		damageMatrix[CRUISER][NEOTANK][0] = -1;
		damageMatrix[CRUISER][NEOTANK][1] = -1;
		damageMatrix[CRUISER][APC_v][0] = -1;
		damageMatrix[CRUISER][APC_v][1] = -1;
		damageMatrix[CRUISER][ARTILLERY][0] = -1;
		damageMatrix[CRUISER][ARTILLERY][1] = -1;
		damageMatrix[CRUISER][ROCKET][0] = -1;
		damageMatrix[CRUISER][ROCKET][1] = -1;
		damageMatrix[CRUISER][A_AIR][0] = -1;
		damageMatrix[CRUISER][A_AIR][1] = -1;
		damageMatrix[CRUISER][MISSILES][0] = -1;
		damageMatrix[CRUISER][MISSILES][1] = -1;
		damageMatrix[CRUISER][FIGHTER][0] = -1;
		damageMatrix[CRUISER][FIGHTER][1] = 55;
		damageMatrix[CRUISER][BOMBER][0] = -1;
		damageMatrix[CRUISER][BOMBER][1] = 65;
		damageMatrix[CRUISER][BCOPTER][0] = -1;
		damageMatrix[CRUISER][BCOPTER][1] = 115;
		damageMatrix[CRUISER][TCOPTER][0] = -1;
		damageMatrix[CRUISER][TCOPTER][1] = 115;
		damageMatrix[CRUISER][BATTLESHIP][0] = -1;
		damageMatrix[CRUISER][BATTLESHIP][1] = -1;
		damageMatrix[CRUISER][CRUISER][0] = -1;
...
//		damageMatrix[CRUISER][SUB][1] = -1;
	...
	private static void damageCalculation(Unit attacker, Hero attHero, Unit defender, Hero defHero, int defTerrainType) {
		...
		calculateStarPowerOpponent(attHero, defender, damageValue);
		calculateStarPowerSelf(defHero, defender, damageValue);
	}
	
	private static void calculateStarPowerOpponent(Hero hero, Unit unit, int damage) {
		calculateStarPower(hero, unit, damage, 0.5);
	}

	private static void calculateStarPowerSelf(Hero hero, Unit unit, int damage) {
		calculateStarPower(hero, unit, damage, 1);
	}

	private static void calculateStarPower(Hero hero, Unit unit, int damage, double starMultiplier) {
		double worth = 0;
