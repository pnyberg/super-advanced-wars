...
public class PowerStar {
	...
	public static void paintNormal(Graphics g, int x, int y) {
		paint(g, x, y, smallSize);
	}

	public static void paintSuper(Graphics g, int x, int y) {
		paint(g, x, y, bigSize);
	}

	private static void paint(Graphics g, int x, int y, int size) {
		int width = size;
		int height = size;
