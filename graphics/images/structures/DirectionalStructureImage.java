...
public class DirectionalStructureImage extends StructureImage {
	...
	private void paintNorthMiniCannon(Graphics g, int x, int y, Color cannonColor) {
		...
		g.setColor(cannonColor);
		g.fillOval(x+tileSize/8, y+tileSize/8, 3 * tileSize / 4, 6 * tileSize / 8);
		g.setColor(Color.black);
		g.drawOval(x+tileSize/8, y+tileSize/8, 3 * tileSize / 4, 6 * tileSize / 8);
	}

	private void paintEastMiniCannon(Graphics g, int x, int y, Color cannonColor) {
		g.fillOval(x+5*tileSize/10, y+tileSize/5, 1 * tileSize / 5, 2 * tileSize / 5);
		g.setColor(Color.black);
		g.drawOval(x+5*tileSize/10, y+tileSize/5, 1 * tileSize / 5, 2 * tileSize / 5);
		g.setColor(cannonColor);
		g.fillOval(x+tileSize/8, y+tileSize/16, 2 * tileSize / 4, 7 * tileSize / 8);
		g.setColor(Color.black);
		g.drawOval(x+tileSize/8, y+tileSize/16, 2 * tileSize / 4, 7 * tileSize / 8);
	}
	...
	private void paintWestMiniCannon(Graphics g, int x, int y, Color cannonColor) {
		g.fillOval(x+3*tileSize/10, y+tileSize/5, 1 * tileSize / 5, 2 * tileSize / 5);
		g.setColor(Color.black);
		g.drawOval(x+3*tileSize/10, y+tileSize/5, 1 * tileSize / 5, 2 * tileSize / 5);
		g.setColor(cannonColor);
		g.fillOval(x+3*tileSize/8, y+tileSize/16, 2 * tileSize / 4, 7 * tileSize / 8);
		g.setColor(Color.black);
		g.drawOval(x+3*tileSize/8, y+tileSize/16, 2 * tileSize / 4, 7 * tileSize / 8);
	}
}